 ...
 * OutStream       FileOutStream(write(byte[] buffer,0,len))      BufferedOutStream(write(byte[] buffer,0,len))/ flush()
...
public class FileReaderWriterTest
{
      public static void main(String[] args)
      {
            ...
            System.out.println(file.getAbsolutePath());//G:\Jetbrains\project2\hello.txt

            File file1 = new File("day09\\hello.txt");//相较于当前工程
            System.out.println(file1.getAbsolutePath());//G:\Jetbrains\project2\day09\hello.txt
      }
      /*
      将day09下的hello.txt文件内容读入程序，并输出到控制台
      说明点：
...
//                {
//                    System.out.println(cbuf[i]);//helloworld123ld
//                }
                //正确的写法
                for (int i = 0;i < len;i++)
                {
...
//                System.out.print(str);
    ...
    public void testFileReaderFileWriter()
    {
        ...
        try
        {
           ...
           //不能使用字符流来处理图片等字节数据
//            File srcFile = new File("1jwjzv.jpg");
//            File destFile = new File("1jwjzv1.jpg");
